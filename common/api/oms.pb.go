...
type CreateOrderRequest struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	CusomterID string                 `protobuf:"bytes,1,opt,name=cusomterID,proto3" json:"cusomterID,omitempty"`
	// / repeated === list
...
func (x *CreateOrderRequest) GetCusomterID() string {
	if x != nil {
		return x.CusomterID
	}
	return ""
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x1e, 0x0a, 0x0a, 0x63, 0x75, 0x73, 0x6f, 0x6d, 0x74, 0x65, 0x72, 0x49, 0x44, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x75, 0x73, 0x6f, 0x6d, 0x74, 0x65, 0x72, 0x49, 0x44, 0x12,
	...
	0x45, 0x75, 0x63, 0x6c, 0x69, 0x64, 0x30, 0x31, 0x39, 0x32, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
